<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Documents.aspx.cs" Inherits="MULTI_NIVEL.Views.Documents" %>
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            ...
                            <div class="row" style="padding-bottom: 20px; position: relative">
                                <div class="col-md-6">
                                    <img src="img/news.png" class="logo-seccion" align="left" />
                                    <h2 class="green"><b>Documentos</b><h2>
                                    <ol class="breadcrumb negro">
                                        <li class="breadcrumb-item "><a href="News.aspx" >Noticias</a></li>
                                        <li class="breadcrumb-item active"><a href="Documents.aspx" class="subrayar">Documentos</a></li>
                                    </ol>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="table-responsive m-t">
								...
								<select id="cboNumRows" name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="form-control input-sm" onchange="cboNumRows_OnChange()">
                                    ...
                                    <table class="table table-bordered dataTables-example dataTable no-footer" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid" style="width: 100%;">
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 30px;" aria-label="Periodo: Activar para ordenar la columna ascendente">Descripcion</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="min-width:82px;width: 60px;" aria-label="Fecha de Publicación: Activar para ordenar la columna ascendente">Fecha</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 50px;" aria-label="Comisión: Activar para ordenar la columna ascendente">Capital</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 50px;" aria-label="Comisión: Activar para ordenar la columna ascendente">Amortización</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 50px;" aria-label="Comisión: Activar para ordenar la columna ascendente">Interes</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 85px;" aria-label=": Activar para ordenar la columna ascendente">Cuota</th>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 80px;" aria-label=": Activar para ordenar la columna ascendente">Pagar En Linea</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 80px;" aria-label=": Activar para ordenar la columna ascendente">Subir Recibo</th>
                                            </tr>
                                        </thead>
