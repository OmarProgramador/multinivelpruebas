<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Commissions.aspx.cs" Inherits="MULTI_NIVEL.Views.Commissions" %>
...
<head>
    ...
    <script src="Script/ScriptCommissions.js"></script>
    <style>
        .bg-plomo{
                ...
                <div class="wrapper-content animated fadeInUp">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <ol class="breadcrumb negro">
                                        <li class="breadcrumb-item active">
                                            <a href="Commissions.aspx" class="subrayar">Mis comisiones</a></li>
                            ...
                            <div id="info_commission" class="m-t">
                                ...
                                <div class="ps">
                                    <ul class="a2">
                                       <%-- <li>Periodo: <asp:Label runat="server" ID=""></asp:Label></li>--%>
                                        <li class="a1" style="list-style:none;text-align:left">Periodo: <asp:Panel style="display:inline-block;text-align:left" runat="server" ID="di"></asp:Panel></li>
                                        <li class="a1" style="list-style:none;text-align:left"> + Afiliacion: <asp:Panel style="display:inline-block;text-align:left" runat="server" ID="af"></asp:Panel></li>
                                        <li class="a1" style="list-style:none;text-align:left"> &nbsp;&nbsp;&nbsp;&nbsp;- Directa: S/.<asp:Panel style="display:inline-block;text-align:left" runat="server" ID="afi"></asp:Panel></li>
                                        <li class="a1" style="list-style:none;text-align:left"> &nbsp;&nbsp;&nbsp;&nbsp;- Aceleracion: S/.<asp:Panel style="display:inline-block;text-align:left" runat="server" ID="rapi"></asp:Panel></li>
                                        <li class="a1" style="list-style:none;text-align:left"> &nbsp;&nbsp;&nbsp;&nbsp;- Equipo: S/.<asp:Panel style="display:inline-block;text-align:left" runat="server" ID="equi"></asp:Panel></li>
                                       
                                        <li class="a1" style="list-style:none;text-align:left"> + Residuales: S/.<asp:Panel style="display:inline-block;text-align:left" runat="server" ID="resi"></asp:Panel></li>
                                        <li class="a1" style="list-style:none;text-align:left"> + Bono Premio: S/.<asp:Panel style="display:inline-block;text-align:left" runat="server" ID="log"></asp:Panel></li>
                                        ...
                                        <li class="a1" style="margin-top:15px ;list-style:none;text-align:left">Total de Comisiones: S/.<asp:Panel style="display:inline-block;text-align:left" runat="server" ID="toti"></asp:Panel></li>
                                    </ul>
                                </div>
                                <%--<div class="modal-header"></div>--%>
                                <center>                                                                      
