<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Red.aspx.cs" Inherits="MULTI_NIVEL.Views.Red" %>
...
<head>
    ...
    <style>
        .bg-affiliate {
            background-color: #efecab80 !important;
        }
    </style>
    <script>
                ...
                <div class="wrapper-content animated fadeInUp">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content" style="overflow: unset !important; height: auto !important; position: relative; min-height: unset !important;">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-9 menu-lateral-opciones" style="display: block">
                                            <div class="col-xs-12">
                                                ...
                                                <div class="col-xs-3 separadorbarra" style="width: 20% !important">
                                                    <a href="Red.aspx">
                                                        <img src="../Resources/Images/redes.png" class="img-responsive center-block" border="0" />Arbol de Patrocinio</a>
                                                </div>
                                                <div class=" col-xs-3 separadorbarra" style="width: 20% !important">
                                                    <a href="Bonus.aspx">
                                ...
                                <div class="col-md-12 col-lg-12  ">
                                    ...
                                    <ol class="breadcrumb negro">
                                        <li class="breadcrumb-item active">
                                            <a href="Red.aspx" class="subrayar">Arbol de Patrocinio</a>
                                        </li>
                            ...
                            <div class="row">
                                <div style="width: 15px; height: 15px; background-color: #efecab80 !important; display: inline-block; border: 1px solid black"></div>
