<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayDepositoQuote.aspx.cs" Inherits="MULTI_NIVEL.Views.PayDepositoQuote" %>
...
<head>
    ...
    <link href="Css/ResponsivePagos.css"  rel="stylesheet"/>
    ...
    <form runat="server" style="margin: 0;">
            ...
            <div id="tab-1" class="tab-content banca-por-internet">
                <div class="paso-1">
                    ...
                    <div class="tabs_internos_content">
                                            ...
                                            <div class="slick-track" role="listbox" style="opacity: 1; width: 1554px; left: 0px;">
                                                <div class="SeleccionFinanciera-item slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" tabindex="-1" role="option" aria-describedby="slick-slide00" style="width: 777px;">
                                                    ...
                                                    <div class="link-wrapper">
                                                        <br />
                                                        <h1>
                                                            <asp:Label ID="txtCuentaBancaria" runat="server" />
                                    ...
                                    <div class="total">
                                        ...
                                        <div id="moneda" class="dd-container" style="width: 93px;">
                                            <asp:DropDownList ID="ddlMoneda" runat="server" class="dd-select" Style="width: 93px; background: rgb(238, 238, 238);">
                                                <asp:ListItem Value="USD" Text="Dolar" />
                                        ...
                                        <div class="total2 ">
                                            ...
                                            <div class="montototal">
                                                ...
                                                <asp:Label ID="lblAmount" Text="10" runat="server" Style="font-size: 20px; float: none;"></asp:Label>
                        ...
                        <asp:Panel ID="divSendLater" runat="server" class="ticket_container" style="margin: 10px; box-shadow: 2px 2px 20px black; border-radius: 8px;">
                            <div class="barras">
                            ...
                            <div class="total" style="padding: 18px">
                                <label style="font-size: 15px">Se le enviará un correo con el detalle de su cuota y travez de un enlace pueda subir una imagen de su comprobante.</label>
        ...
        <script type="text/javascript">
            window.onload = function () {
                ...
                let monedaleter = dmoneda.options[dmoneda.selectedIndex].text;
