...
{
    public partial class VysorCertificadoSTBY : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string ruta = HttpContext.Current.Server.MapPath("~/Resources/PoliticsPdf/") + "Certi" + username + correlativo;
                if (File.Exists(ruta))
                {
                    File.Delete(ruta);
                }
