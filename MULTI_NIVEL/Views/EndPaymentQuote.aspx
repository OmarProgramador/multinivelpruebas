<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EndPaymentQuote.aspx.cs" Inherits="MULTI_NIVEL.Views.EndPaymentQuote" %>
    ...
    <form id="form1" runat="server">
        <div id="contenedor" style="">
            <div style="text-align:center;margin:10%;background-color:#fff;height:575px;border-radius:8px;box-shadow:5px 5px 18px Black">
                ...
                <h1 style="display:inline;color:#3f7cd8;  margin-left: 2%; margin-right: 2%">Pago Exitoso</h1> 
               

                <p style="color:#3f7cd8;padding:20px;font-size:20px;padding-left:50px;padding-right:50px">Excelente. Gracias por tu pago y compromiso.</p>
            
                <a href="Payments.aspx" class="btn btn-primary">Volver al Inicio</a>
            </div>
            <div>
