<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdvancePayWallet.aspx.cs" Inherits="MULTI_NIVEL.Views.AdvancePayWallet" %>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row sombra">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <p>Total A Pagar : 
                                                    <asp:Label ID="Amount" Text="text" runat="server" /></p>
                                            </div>
                                            <div class="col-lg-12">
                                                <br />
