<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayType.aspx.cs" Inherits="MULTI_NIVEL.Views.PayType" %>
...
<head id="ctl00_Head1">
    ...
    <title>Proceso de Pago - inResorts</title>
...
//]]>
                    ...
                    <div class="box_center">
                            ...
                            <form id="form1" runat="server">
                                <div class="box_proceso_compra" style="border-radius: 27px; box-shadow: 9px 8px 15px 0px black;">
                                    <div class="box_mediospago_lista">
                                        ...
                                        <div class="box_mediospago_lista_titulo anchura" style="text-decoration-color: chartreuse; width: 95%;">
                                            <div id="ctl00_ContentPlaceHolder1d" class="box_mediospago_lista_item2 holi" style="font-size: 16px; width: 98%; color: black; font-weight: 100">
                                                <div class="box_mpli_check">
                                                    <asp:RadioButton runat="server" GroupName="packafilia" ID="rbtWallet" value="5" Style="margin-left: 8px;"></asp:RadioButton>
                                                </div>
                                        ...
                                        <div onclick="selectRBMP(&#39;ctl00_ContentPlaceHolder1_rbVisa&#39;);">
                                            <div id="ctl00_ContentPlaceHolder1_DivMPVisa " class="box_mediospago_lista_item holi">
                                                <div class="box_mpli_check">
                                                    ...
                                                    <asp:RadioButton runat="server" GroupName="packafilia" ID="rdrCulqi" value="1"></asp:RadioButton>
                                                </div>
                                            ...
                                            <div id="ctl00_ContentPlaceHolder1_DivMPVisa" class="box_mediospago_lista_item">
                                                ...
                                                <div id="ctl00_ContentPlaceHolder1_DivMPSafetyPayE" class="box_mediospago_lista_item2">
                                                    <div class="box_mpli_check">
                                                        ...
                                                        <asp:RadioButton runat="server" GroupName="packafilia" ID="rdrTransfer" value="2"></asp:RadioButton>
                                                    </div>
                                                ...
                                                <div id="ctl00_ContentPlaceHolder1_DivMPSafetyPayT" class="box_mediospago_lista_item2">
                                                    <div class="box_mpli_check">
                                                        ...
                                                        <asp:RadioButton runat="server" GroupName="packafilia" ID="rdrTransfer2" value="3"></asp:RadioButton>
                                                    </div>
                                                    <div class="box_mpli_img3" style="width: 70px; height: 70px; display: flex">
                                                ...
                                                <div id="ctl00_ContentPlaceHolder1_DivMPSafetyPayT" class="box_mediospago_lista_item2">
                                                    <div class="box_mpli_check">
                                                        <!--<input id="ctl00_ContentPlaceHolder1_rbSafetyPayT" type="radio" name="ctl00$ContentPlaceHolder1$gpcheck" value="8">-->
                                                        <asp:RadioButton runat="server" GroupName="packafilia" ID="rdrStor" value="4"></asp:RadioButton>
                                                    </div>
                                                    <div class="box_mpli_img3" style="width: 40px; height: 90px; display: flex">
                                   ...
                                   <ul>
                                    ...
                                    <div class="box_mediospago_bloquepago">
                                        ...
                                        <div class="box_mediospagob_valor">
                                            ...
                                            S/.<asp:Label ID="lblCostQuote" runat="server"></asp:Label></a>
                                        </div>
                                        ...
                                        <div class="box_mediospagob_comprar" id="box_mediospagob_comprar">
                                            ...
                                            <%--<asp:Button style="display:none" ID="btnProcessPay" runat="server" class="btn btn-xl btn-primary m-t-n-xs plomo" Text="Continuar" OnClick="btnProcessPay_Click" value="Pagar Procesar" >
                         </asp:Button>--%>
                                            <%--<center>  
                                <asp:Button ID="btnContinue" data-loading-text=" Procesando Orden" runat="server" class="btn btn-xl btn-primary m-t-n-xs plomo" Text="Continuar" OnClick="btnProcessPay_Click" value="Continuar" >
                                </asp:Button>
                            </center>--%>
                                            <!--boton--->


                                            <%--                               <asp:Button ID="Button1" CssClass="btn btn-primary" data-loading-text=" Procesando Orden" runat="server" Text="Continuar" OnClick="btnProcessPay_Click" />--%>
                                            <center>
                               <asp:Button ID="btnProcess" CssClass="btn btn-primary" data-loading-text="Procesando Orden" runat="server" style="width: 70%;height: 33px;border-radius: 18px;background-color: #44709c;color: white;font-weight: bold;" Text="Procesar" OnClick="btnProcess_Click" />
                                    ...
                                    <div class="box_mediospago_bloquepago">
                                        ...
                                        <div class="exchange">
                                            <!--<span id="ctl00_ContentPlaceHolder1_lblTotalAPagar">S/ 28.90</span>-->
                                            S/.<asp:Label ID="lblExchange" runat="server"></asp:Label></a>
                                        </div>
                                    </div>
                        ...
                        <div class="box_proceso_compra" style="margin-top: 30px; margin-bottom: 30px;">
                            ...
                            <div class="box_total_oferta">
                                <div class="box_total_oferta_valor_total"><span id="ctl00_ContentPlaceHolder1_lblTotal">
                                    <asp:Label ID="lblTot" runat="server"></asp:Label> </div>
    ...
    <div style="display: none;">
        <input type="image" name="ctl00$btnSuscribirme2" id="ctl00_btnSuscribirme2" border="0" src="./Proceso de Pago - Cuponidad_files/suscribirme_cupon_cuponidad.png" style="height: 45px; width: 175px; border-width: 0px;">
    </div>
...
//]]>
    ...
    <div tabindex="-1" role="dialog" class="ui-dialog ui-corner-all ui-widget ui-widget-content ui-front ui-draggable" aria-describedby="logearme" aria-labelledby="ui-id-1" style="display: none;">
        <div class="ui-dialog-titlebar ui-corner-all ui-widget-header ui-helper-clearfix ui-draggable-handle" style="display: none;"><span id="ui-id-1" class="ui-dialog-title">&nbsp;</span>
        ...
        <div id="logearme" style="" class="ui-dialog-content ui-widget-content">
            ...
            <div class="mainText">
                <div id="dialogClose">
                    <a href="https://cuponidad.pe/ProcesoCompra.aspx#" onclick="$(&#39;#logearme&#39;).dialog(&#39;close&#39;); return false;">
                        <img src="./Proceso de Pago - Cuponidad_files/cerrar_suboffers_cupon.png" width="16" height="16" border="0" alt="cerrar bienvenido"></a>
                </div>
                ...
                <div id="TextRegistrateAqui" class="TextRegistrateAqui">
                    <a href="https://cuponidad.pe/Register.aspx" class="TextRegistrateAqui"><b>Regístrate</b>, haz clic aqui!</a>
                </div>
                <div id="RegistroFace">
    ...
    <div tabindex="-1" role="dialog" class="ui-dialog ui-corner-all ui-widget ui-widget-content ui-front ui-draggable" aria-describedby="PublicidadPopupDestok" aria-labelledby="ui-id-2" style="display: none;">
        <div class="ui-dialog-titlebar ui-corner-all ui-widget-header ui-helper-clearfix ui-draggable-handle" style="display: none;"><span id="ui-id-2" class="ui-dialog-title">&nbsp;</span>
            <button type="button" class="ui-button ui-corner-all ui-widget ui-button-icon-only ui-dialog-titlebar-close" title="Close"><span class="ui-button-icon ui-icon ui-icon-closethick"></span><span class="ui-button-icon-space"></span>Close</button></div>
        <div id="PublicidadPopupDestok" class="ui-dialog-content ui-widget-content">
    ...
    <div tabindex="-1" role="dialog" class="ui-dialog ui-corner-all ui-widget ui-widget-content ui-front ui-draggable" aria-describedby="PublicidadPopupMobile" aria-labelledby="ui-id-3" style="display: none;">
        <div class="ui-dialog-titlebar ui-corner-all ui-widget-header ui-helper-clearfix ui-draggable-handle" style="display: none;"><span id="ui-id-3" class="ui-dialog-title">&nbsp;</span>
            <button type="button" class="ui-button ui-corner-all ui-widget ui-button-icon-only ui-dialog-titlebar-close" title="Close"><span class="ui-button-icon ui-icon ui-icon-closethick"></span><span class="ui-button-icon-space"></span>Close</button></div>
        <div id="PublicidadPopupMobile" class="ui-dialog-content ui-widget-content">
    ...
    <div tabindex="-1" role="dialog" class="ui-dialog ui-corner-all ui-widget ui-widget-content ui-front ui-draggable" aria-describedby="suscribirme" aria-labelledby="ui-id-4" style="display: none;">
        <div class="ui-dialog-titlebar ui-corner-all ui-widget-header ui-helper-clearfix ui-draggable-handle" style="display: none;"><span id="ui-id-4" class="ui-dialog-title">&nbsp;</span>
            <button type="button" class="ui-button ui-corner-all ui-widget ui-button-icon-only ui-dialog-titlebar-close" title="Close"><span class="ui-button-icon ui-icon ui-icon-closethick"></span><span class="ui-button-icon-space"></span>Close</button></div>
        <div id="suscribirme" style="" class="ui-dialog-content ui-widget-content">
            <div class="contenedorImg">
    ...
    <%--<div id="onesignal-bell-container" class="onesignal-bell-container onesignal-reset onesignal-bell-container-bottom-right">
        <div id="onesignal-bell-launcher" class="onesignal-bell-launcher onesignal-bell-launcher-md onesignal-bell-launcher-bottom-right onesig
            nal-bell-launcher-theme-default onesignal-bell-launcher-active" style="bottom: 75px; right: 5px;">
