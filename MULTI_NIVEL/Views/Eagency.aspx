<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Eagency.aspx.cs" Inherits="MULTI_NIVEL.Views.Eagency" %>
...
<%--                                        <li class="breadcrumb-item "><a href="TravelBenefits.aspx">Beneficios de Viajes</a></li>--%>
                                        <li class="breadcrumb-item active"><a href="Eagency.aspx">E-agencias</a></li>
                                        ...
                                        <div class="col-md-4 col-sm-4 noproducto" data-id="82" data-name="">
                                            <div class="ibox-content text-center no-border">
                                               ...
                                               <%-- <div class="input-group bootstrap-touchspin input-group-sm">
                                                    ...
                                                    <input class="cantidad input-sm text-center form-control" name="cant_prod_82" style="display: block;" value="0" type="text">
                                                </div>--%>
