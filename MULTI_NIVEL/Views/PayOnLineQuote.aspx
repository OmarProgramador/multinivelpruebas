<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayOnLineQuote.aspx.cs" Inherits="MULTI_NIVEL.Views.PayOnLineQuote" %>
...
<body class="top-navigation pace-done">
    ...
    <form id="form1" runat="server">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-8 col-md-offset-1">
                                                    ...
                                                    <p>
                                                        ...
                                                        <asp:DropDownList ID="ddlcurrencyCode" Style="margin-left: 20px; padding: 3px; border-radius: 3px;" runat="server">
                                                            <asp:ListItem Value="USD" Text="Dolares" />
                                                            <asp:ListItem Value="PEN" Text="Soles" />
                                                        </asp:DropDownList>
                                                    </p>
                                                    <p>
                                                        <asp:Panel ID="DivType" runat="server">
                                                            Tipo de Cambio : 
                                                        <asp:Label ID="TypeChange" Text="" runat="server" />
                                                        </asp:Panel>
                                                    </p>
                                                    <asp:Label ID="Note" runat="server" Style="color: green;"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        <br />
        ...
        <script type="text/javascript"> 
            ...
            var amountDolar = parseFloat(document.getElementById('AmountTotal').innerText);
            ...
            document.getElementById('ddlcurrencyCode').onchange = function () {
                ...
                document.getElementById('CurrencyCode').innerText = "USD";

                document.getElementById('AmountTotal').innerText = amountDolar.toString();

                if (cc == "PEN") {

                    let typeChange = parseFloat(document.getElementById('TypeChange').innerText);
                    document.getElementById('AmountTotal').innerText = (amountDolar * typeChange).toFixed(2);
            ...
            function culqi() {
                ...
                if (Culqi.token.id) { // ¡Objeto Token creado exitosamente!
                    ...
                    $.post("PayOnLineQuoteC.aspx", $("#form1").serialize()).done(function (_data) {
                        let mesa = "";
                        if (_data == "true") {
                            mesa = "El Pago se realizo con exitó.";
                        }
                        location.href = "Payments.aspx?msg=" + mesa;
                    });
