<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayDeposito3.aspx.cs" Inherits="MULTI_NIVEL.Views.PayDeposito3" %>
                ...
                <div class="Header-content">
                    <div class="Header-tabs">
                        <div class="left" style="">
                            <a id="tabOnline" href="#" title="Banca por internet" class="button is-active">Oficina y Club</a>
                                                ...
                                                <div class="SeleccionFinanciera-item slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" tabindex="-1" role="option" aria-describedby="slick-slide00" style="width: 777px;">
                                                    ...
                                                    <center>
                                                        <div class="link-wrapper">
                                                            <a href="#" class="link seleccionado"  style="overflow: hidden; padding-top:8px;max-width: 140px;height: 95px;width:138px;line-height: 87px;" id="1005" data-payment-code="1005_ONLINE_B2C" tabindex="0">
                                                                <img  style="max-width: 135px;"   height="107" width="125" alt="Banco de Crédito" src="img/logosf2.png" >
                                                            </a>
                                                        </div>
                                                     </center>
                                                    <div class="link-wrapper">
                                        ...
                                        <div class="colizq" data-bind="foreach: items">
                                            <li>
                                                <div data-bind="html: Message">
                                                    <p id="step_1">Acercarse a la oficina o al Club</p>
                                                </div>
                                            </li>

                                            <li>
                                                <div data-bind="html: Message">
                                                    <p id="step_2">Realizar el abono correspondiente ya se en efectivo o con tarjeta de debito o credito</p>
                                                </div>
                                            </li>
                                        </div>
                                        ...
                                        <div class="colder" data-bind="foreach: items">
                                            <li>
                                                <p data-bind="html: Message">
                                                    <p id="step_3">Un encargado de la compañia subira el comprobante de pago en la sección de validación</strong></p>
                                                </p>
                                            </li>

                                            <li>
                                                <p data-bind="html: Message">
                                                    <p id="step_4">Su pago estara validado en el momento.</p>
                                                </p>
                                            </li>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="botones_instrucciones">
                                        <%--<a  href="" class="boton_azul" style="width:180px;text-align:center">
                                                        Enviar Ahora</a>--%>
                                        <asp:Button ID="btnEnviarAhora" Text="Enviar" runat="server" CssClass="boton_azul" Style="width: 180px; text-align: center"   />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="ticket_container" style="margin: 10px; box-shadow: 2px 2px 20px black; border-radius: 8px">
                            <div class="barras">
                                             ...
                                             <br />
                                                ...
                                                <div class="botones_instrucciones">
                                                   <%-- <a  href="Payments.aspx" class="" style="width:180px" >
                                                    ...
                                                    <asp:button ID="btnEnviarDespues" text="Enviar Despues" runat="server" CssClass="boton_azul"  style="width:180px"   />
                                                </div>                                                                                       
                                        </div>
                                    </div>
                               </center>
