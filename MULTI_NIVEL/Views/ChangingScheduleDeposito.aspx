<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangingScheduleDeposito.aspx.cs" Inherits="MULTI_NIVEL.Views.ChangingScheduleDeposito" %>
                                      ...
                                      <h2>Cuenta InterbBancaria<asp:Label ID="txtCuentaInterBancaria" runat="server"/></h2>
                                        ...
                                        <div class="montototal">
                                            <h4 style="color: white; text-align: center; padding: 0px 15px 0px 0px">
                                                <asp:Label ID="LblBankAccount" style="font-size:17px;color: white;" Text="" runat="server" />
                                            </h4>
                                        </div>
                                        ...
                                        <div class="montototal">
                                            <h4 style="color: white; text-align: right; padding: 0px 15px 0px 0px">
                                                <asp:Label ID="LblInterbankAccount" style="font-size:17px;color: white;" Text="" runat="server" />
                                            </h4>
                                        </div>
                                    ...
                                    <div class="total">
                                        ...
                                        <div class="total2">
                                            ...
                                            <div class="montototal">
                                                ...
                                                <asp:Label ID="lblAmount" runat="server" Style="font-size: 20px"></asp:Label>
                                                <span style="font-size: 20px">S/.</span><span class="caret"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tiempo">
                            ...
                            <center>
                                <div class="tiempo" style="width: 245px; background-color: #f6f6f6; text-align: right">
                                    <div>
                                        ...
                                        <asp:linkbutton  OnClick="btnSendNow_Click" text="Enviar" runat="server" ID="btnSendNow" CssClass="boton_azul" style="width: 180px; text-align: center" />
                                        </div>
