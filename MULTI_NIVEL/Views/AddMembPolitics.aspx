<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddMembPolitics.aspx.cs" Inherits="MULTI_NIVEL.Views.AddMembPolitics" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Politicas | inResorts</title>
    <meta charset='utf-8' />
            ...
            <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background-color: #f3f3f4">
                <div id="header" class="container">
                    <div class="navbar-header" style="margin: 10px">
                        <div>
                           <a href="Index.aspx"><img class="logo img-responsive center-block" src="img/novologo.png" style="height: 80px" /></a> 
                        </div>
                    </div>
                </div>
            </nav>
                ...
                <div class="container">
                    ...
                    <div>
                        ...
                        <div align='center' style="color: teal; font-size: 20px">
                            <h1 style="padding:0px;margin:0px;">SOLICITUD PARA SER MIEMBRO DE INRESORTS</h1>
                            <blockquote>
                            ...
                            <p style="text-align:center;width:500px;margin:auto;">
                               ...
                               <asp:HyperLink ID="hlPagares" runat="server" Target="_blank" Style="text-decoration: none; color: steelblue; cursor: pointer" Text="Click aqui para leer informe de Pagares" />
                                ...
                                <a style="text-decoration: none; color: steelblue; cursor: pointer" href="../Doc/Plan_beneficios_riberadelrio_inResorts.pdf" target="_blank" class="link">Haz clic aquí para leer: &nbsp;Plan de Beneficios </a>
                                <br>
                                <br>
                        ...
                        <p align="center" style="margin-left: 60px; margin-right: 60px">
                        ...
                        <font size="3" style="font-weight:normal; color: teal">
                            ...
                            <div align="center" style="padding-top: 0px;">
                                ...
                                &nbsp;&nbsp;
                            <input type="button" value="No acepto" class="btn btn-primary" style="background-color: #4cb13e; border-color: #4cb13e; padding: 10px; border-radius: 6px; color: white; font-size: 17px; margin: 8px" onclick="window.location = 'Index.aspx';">
