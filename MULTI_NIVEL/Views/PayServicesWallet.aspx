<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayServicesWallet.aspx.cs" Inherits="MULTI_NIVEL.Views.PayServicesWallet" %>
...
<body class="top-navigation pace-done">
    ...
    <form id="form1" runat="server">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row sombra">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <asp:Label ID="AmountTotal" Text="text" runat="server" />
                                            </div>
                                            <div class="col-lg-12">
                                            ...
                                            <asp:Panel ID="PnOthers" runat="server" style="display:none">
                                                <div class="col-lg-12">
                                                    <hr />
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="tiempo" style="padding-top:40px;background-color:#f6f6f6;text-align:center">
                                                        ...
                                                        <div style="text-align: center">
                                                            <asp:Button ID="ProcesarPay" Text="Procesar" runat="server" class="btn btn-primary"  />
                                                        </div>
                                                    </div>
                                                </div>
                                            </asp:Panel>
        ...
        <script src="Script/AddPayQuoteCulqi.js"></script>
        <script>
