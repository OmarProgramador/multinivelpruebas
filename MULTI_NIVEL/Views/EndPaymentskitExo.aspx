<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EndPaymentskitExo.aspx.cs" Inherits="MULTI_NIVEL.Views.EndPaymentskitExo" %>
    ...
    <form id="form1" runat="server">
        <div id="contenedor" style="">
            <div style="text-align:center;margin:10%;background-color:#fff;height:575px;border-radius:8px;box-shadow:5px 5px 18px Black">
                ...
                <a href="Index.aspx" class="btnini" id="btnini" style="color:White;font-size:18px;background-color:#0e69b7;box-shadow:3px 3px 8px black;cursor:pointer;width:300px;height:50px;border-radius:8px;border:none;padding: 15px;text-decoration: none;">Volver al Inicio</a>
            </div>
            <div>
