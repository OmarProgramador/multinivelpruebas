<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayDeposito2.aspx.cs" Inherits="MULTI_NIVEL.Views.PayDeposito2" %>
                                                ...
                                                <div class="SeleccionFinanciera-item slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" tabindex="-1" role="option" aria-describedby="slick-slide00" style="width: 777px;">
                                                    ...
                                                    <center>
                                                        <div class="link-wrapper">
                                                            <a href="#" class="link seleccionado"  style="overflow: hidden; height: 105px; " id="1005" data-payment-code="1005_ONLINE_B2C" tabindex="0">
                                                                <img  height="87" width="105" alt="Banco de Crédito" src="img/bcp123.png">
                                                            </a>
                                                        </div>
                                                     </center>
                                                    <div class="link-wrapper">
                                        ...
                                        <div class="colizq" data-bind="foreach: items">
                                            <li>
                                                <div data-bind="html: Message">
                                                    <p id="step_1">Ir a la sección pagar y transferir - Hacer una transferencia</p>
                                                </div>
                                            </li>

                                            <li>
                                                <div data-bind="html: Message">
                                                    <p id="step_2">Seleccionar la opción a otras cuentas BCP</p>
                                                </div>
                                            </li>
                                        </div>
                                        ...
                                        <div class="colder" data-bind="foreach: items">
                                            <li>
                                                <p data-bind="html: Message">
                                                    <p id="step_3"> Poner la cuenta corriente de la compañia en cuenta destino y pagar</p>
                                                </p>
                                            </li>

                                            <li>
                                                <p data-bind="html: Message">
                                                    <p id="step_4">Subir el comprobante de pago en la sección de validación. Su pago estara validado dentro de las proximas 24 horas</p>
                                                </p>
                                            </li>
                                        </div>
