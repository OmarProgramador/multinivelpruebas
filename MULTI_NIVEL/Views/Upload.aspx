<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Upload.aspx.cs" Inherits="Upload.Views.Upload" %>
...
<body class="container" id="peru" style="">
    <form runat="server" style="margin: 0;">
                    ...
                    <div class="tabs_internos_content">
                                    ...
                                    <div class="SeleccionFinanciera-slide slick-initialized slick-slider">
                                        ...
                                        <div aria-live="polite" class="slick-list draggable">
                                            <div class="slick-track" role="listbox" style="opacity: 1; width: 1554px; left: 0px;">
                                                <div class="SeleccionFinanciera-item slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" tabindex="-1" role="option" aria-describedby="slick-slide00" style="width: 777px;">
                                                    <!-- ko foreach: items -->
                                                    <center>
                                                        <div class="link-wrapper">
                                                            <a href="#" class="link seleccionado"  style="overflow: hidden; height: 47px; line-height: 47px;" id="1005" data-payment-code="1005_ONLINE_B2C" tabindex="0">
                                                                <img  height="47" width="105" alt="Banco de Crédito" src="./pagos_files/bank_4_1005_1.jpg">
                                                            </a>
                                                        </div>
                                                     </center>
                                                    <div class="link-wrapper">
                        ...
                        <div class="ingresa" style="display: none;">
                            ...
                            <div class="ingresa_tel">
                                ...
                                <input id="cod1" type="submit" value="Obt?n tu código de pago" class="enviar">
                            ...
                            <div class="ticket ticket-online">
                                <div class="ticket_container">
                                    <div class="barras">
                                        ...
                                        <span data-bind="text: TransactionId.Value.Text">701838</span>
                                    </div>
                                    <div class="total">
                                        <strong>Moneda</strong>
                                        <div id="moneda" class="dd-container" style="width: 93px;">
                                            <div class="dd-select" style="width: 93px; background: rgb(238, 238, 238);">
                                                <input class="dd-selected-value" type="hidden" value="PEN"><a class="dd-selected"><label class="dd-selected-text">Soles</label></a><span class="dd-pointer dd-pointer-down"></span>
                                            </div>
                                        ...
                                        <div class="total2">
                                            ...
                                            <div class="montototal">
                                                <strong>TOTAL</strong>
                                                <span data-bind="text: totalToPay">S/ 28.90</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tiempo">
                                        <div>
                                            <h3 class="solomin">Recuerda que te quedan:</h3>
                                            <span class="clock">
                                                <i class="iconp_clock"></i>
                                            </span>
                                            <span class="strong">
                                                <span id="timer_hor_1" data-horas="11">11</span>h :
											  
                                                <span id="timer_min_1" data-minutos="55">54</span>m :
											  
                                                <span id="timer_seg_1" data-segundos="6">07</span>s
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="colizq" data-bind="foreach: items">
                                            <li>
                                                <div data-bind="html: Message">
                                                    <p id="step_1">Selecciona - <strong>"Pagar y Transferir"</strong> - <strong>"Hacer una tranferencia".</strong></p>
                                                </div>
                                            </li>

                                            <li>
                                                <div data-bind="html: Message">
                                                    <p id="step_2">Elige <strong>"A otras cuentas de - BCP"</strong><strong></strong></p>
                                                </div>
                                            </li>
                                        </div>
                                        ...
                                        <div class="colder" data-bind="foreach: items">
                                            <li>
                                                <p data-bind="html: Message">
                                                    <p id="step_3">Ingrese tu <strong>"cuenta destino"</strong> <strong data-bind="text: TransactionId.Value.Text"></strong></p>
                                                </p>
                                            </li>

                                            <li>
                                                <p data-bind="html: Message">
                                                    <p id="step_4">Selecciona la Cuenta o Tarjeta de Crédito de cargo y ¡Listo!</p>
                                                </p>
                                            </li>
                                        </div>
                        ...
                        <center>
                         <h2 style="margin:30px 10px 10px 10px">Elija una opción para continuar</h2>
        ...
        <asp:Button ID="btnEnv" runat="server" Text="Enviar" OnClick="btnEnv_Click" />
    </form>
</body>
</html>
