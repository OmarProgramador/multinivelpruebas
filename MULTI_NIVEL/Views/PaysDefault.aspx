<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaysDefault.aspx.cs" Inherits="MULTI_NIVEL.Views.PaysDefault" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <div class="table-responsive m-t">
								...
								<select id="cboNumRows" name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="form-control input-sm" onchange="cboNumRows_OnChange()">
                                    ...
                                    <table class="table table-bordered dataTables-example dataTable no-footer" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid" style="width: 1814px;">
                                        <thead>
                                            <tr role="row">
                                                 <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 10px;" aria-label="Periodo: Activar para ordenar la columna ascendente">Nro</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 10px;" aria-label="Periodo: Activar para ordenar la columna ascendente">Name</th>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 150px;" aria-label="Fecha de Publicación: Activar para ordenar la columna ascendente">Fecha</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 150px;" aria-label="Comisión: Activar para ordenar la columna ascendente">Monto</th>
                                                 
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 150px;" aria-label="Comisión: Activar para ordenar la columna ascendente">Accion</th>
     ...
     <script src="Script/PaysDefault.js"></script>
</body>
</html>
