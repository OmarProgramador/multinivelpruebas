<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PoliticsStaBye.aspx.cs" Inherits="MULTI_NIVEL.Views.PoliticsStaBye" %>
    ...
    <form id="form1" runat="server">
                    ...
                    <div>
                        ...
                        <div align='center' style="color: teal; font-size: 20px">
                            ...
                            <p align="center">
                                ...
                                <a style="text-decoration: none; color: steelblue; cursor: pointer" id="btnContato" href="VisorStandBy.aspx" target="_blank">Haz clic aquí para leer: &nbsp; Contrato de Membresia </a>
                                <br>
                                <br>
                                ...
                                <a style="text-decoration: none; color: steelblue; cursor: pointer" href="VysorCertificadoSTBY.aspx" target="_blank" class="link">Haz clic aquí para leer: &nbsp;Certificado StandBy</a>
        ...
        <script type="text/javascript"> 
            document.getElementById('cbagree2').onchange = function () {
                if (this.checked) {                    
                    window.open("/Views/VisorStandBy.aspx", '_blank')
                    this.focus();
                }
            }
                        
            document.getElementById('cbagree4').onchange = function () {
                if (this.checked) {                   
                    window.open("/Views/VysorCertificadoSTBY.aspx", '_blank')
                }
            }
        </script>
    </form>
