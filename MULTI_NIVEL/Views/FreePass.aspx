<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreePass.aspx.cs" Inherits="MULTI_NIVEL.Views.FreePass" %>
...
//]]>
    ...
    <div id="contenedor" style="margin-top:1px !important">
                 ...
                 <div class="box_proceso_compra" style="border-radius:27px;"">
                    <div class="box_mediospago_lista">
                        ...
                        <div onclick="selectRBMP(&#39;ctl00_ContentPlaceHolder1_rbVisa&#39;);">
                            <div id="ctl00_ContentPlaceHolder1_DivMPVisa" class="box_mediospago_lista_item" style="width: 397px;margin: 9px;">
                                ...
                                <div class="box_mpli_img"> 
                                    ...
                                    <img src="./Proceso de Pago - Cuponidad_files/americanexpresspayu2.png" border="0">
                                </div>                            
        ...
        <asp:Label ID="lblDiscount" runat="server" Text="S/ 0.00"></asp:Label>
                        ...
                        <asp:Button ID="btnContinue" runat="server" class="btn btn-xl btn-primary m-t-n-xs plomo" Text="Procesar" OnClick="btnContinue_Click" value="Pagar Procesar" style="display:none;">
                         </asp:Button>
                            
                            <!--boton--->

                            <asp:Button ID="btnProcess" runat="server" Text="Procesar" OnClick="btnProcess_Click" />
