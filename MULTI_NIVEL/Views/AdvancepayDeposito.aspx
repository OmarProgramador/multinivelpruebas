<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdvancepayDeposito.aspx.cs" Inherits="MULTI_NIVEL.Views.AdvancepayDeposito" %>
                            ...
                            <center>
                                <div class="tiempo" style="width: 245px; background-color: #f6f6f6; text-align: right">
                                    <div>
                                        ...
                                        <asp:linkbutton  OnClick="btnEnviarAhora_Click" text="Enviar" runat="server" ID="btnEnviarAhora" CssClass="boton_azul" style="width: 180px; text-align: center" />
                                        </div>
                                        <asp:button text="text" runat="server" id="bano" style="display:none;"/>
                                    </div>
                                </div>
                             </center>
                        </div>
