<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddMembCulqui.aspx.cs" Inherits="MULTI_NIVEL.Views.AddMembCulqui" %>
        ...
        <script type="text/javascript"> 
            ...
            function culqi() {
                ...
                if (Culqi.token.id) { // ¡Objeto Token creado exitosamente!
                    ...
                    $.post("AddMembCulquiC.aspx", $("#form1").serialize()).done(function (_data) {
                        alert(_data);
                    });
