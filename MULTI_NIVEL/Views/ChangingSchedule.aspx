<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangingSchedule.aspx.cs" Inherits="MULTI_NIVEL.Views.ChangingSchedule" %>
                                ...
                                <div class="box_proceso_compra" style="border-radius: 27px; box-shadow: 9px 8px 15px 0px black;">
                                         ...
                                         <div class="box_mediospago_lista_titulo anchura" style="text-decoration-color: chartreuseM; width: 95%;">
                                            <div id="ctl00_ContentPlaceHolder1_DivMPSafetyPayT" class="box_mediospago_lista_item2 holi" style="font-size: 16px; width: 98%; color: black; font-weight: 100">
                                                <div class="box_mpli_check">
                                                    <asp:RadioButton runat="server" GroupName="packafilia" ID="rbtWallet" value="9" Style="margin-left: 8px;"></asp:RadioButton>
                                                </div>
                                    ...
                                    <div class="box_mediospago_bloquepago">
                                        ...
                                        <div class="box_mediospagob_valor">
                                            ...
                                            S/.<asp:Label ID="lblValueTotal" runat="server"></asp:Label></a>
                                        </div>
                                        ...
                                        <div class="box_mediospagob_comprar" id="box_mediospagob_comprar">
                                            ...
                                            <center>
                                                <asp:Button ID="btnContinue" data-loading-text="Procesando Orden" runat="server" class="btn btn-primary btn-lg" 
                                                    Text="Continuar" OnClick="btnContinue_Click" value="Continuar"></asp:Button>
                                            </center>
