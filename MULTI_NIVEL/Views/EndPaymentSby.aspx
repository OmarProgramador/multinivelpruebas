<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EndPaymentSby.aspx.cs" Inherits="MULTI_NIVEL.Views.EndPaymentSby" %>
    ...
    <form id="form1" runat="server">
        <div id="contenedor" style="">
            <div style="text-align:center;margin:10%;background-color:#fff;height:575px;border-radius:8px;box-shadow:5px 5px 18px Black">
                ...
                <p style="color:#3f7cd8;padding:20px;font-size:20px;padding-left:50px;padding-right:50px">Ya esta reservando tu CUPO FUNDADOR. Bienvenido a Ribera del Rio .</p>            
